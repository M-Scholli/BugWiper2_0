...
void loop() { 
    ...
    delay(1000);
    DEBUG_INFO("ADC_Current:" + String(BW_ADC_current_mA) + " HB1:" + String(BW_ADC_btn_hb1) + " HB2:" + String(BW_ADC_btn_hb2));
    DEBUG_INFO("Encoder_count:" + String((int32_t)motor_enc_count));
